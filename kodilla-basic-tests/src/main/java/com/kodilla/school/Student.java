...
public class Student {
    ...
    private String name;
    private Grades maths;       // tablica z ocenami z matmy
    private Grades physics;     // tablica z ocenami z fizyki itd...
    private Grades geography;
    private Grades history;

    public Student(String name) {
        this.name = name;
        this.maths = new Grades();  // private int[] values; int size
    ...
    public void addMathGrade(int grade) {
        if (grade > 0 && grade < 7) {
            this.maths.add(grade);  // dodanie oceny do tablicy maths
        }
    }
